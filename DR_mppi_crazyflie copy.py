...
python3 "DR_mppi_crazyflie copy.py"  --obs-update-steps 15 --steps 400 --save
...
def simulate(
    ...
    if dr_eps_cvar is not None:
        params.dr_eps_cvar = float(dr_eps_cvar)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dr-eps-cvar", type=float, default=0.0, help="Override the DR-CVaR Wasserstein radius.")

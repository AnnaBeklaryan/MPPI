#!/usr/bin/env python3
"""Physical Crazyflie figure-eight flight using MPPI and Vicon avoidance.
...
avoidance. A farther point on the optimized prediction is streamed to cf_1.
"""
...
def run_physical_mppi_sequence(
    ...
    """Fly cf_1 with MPPI while reading cf_2 only from Vicon."""
    ...
    try:
        ...
        print(
            f"MPPI flight started on {ctrl.device}: "
            f"{args.ego_body!r}=MPPI; "
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "Fly physical cf_1 with MPPI and read cf_2 obstacle data from "

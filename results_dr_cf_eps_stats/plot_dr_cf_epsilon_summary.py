#!/usr/bin/env python3
"""
Create a Crazyflie collision-probability-vs-epsilon plot from dr_cf_epsilon_summary.csv.

Examples:
  python3 results_dr_cf_eps_stats/plot_dr_cf_epsilon_summary.py
  python3 results_dr_cf_eps_stats/plot_dr_cf_epsilon_summary.py --x-min 0.02 --x-max 0.08
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--x-max", type=float, default=DEFAULT_X_MAX, help="Upper x-axis limit.")
